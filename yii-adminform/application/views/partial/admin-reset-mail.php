                            ...
                            <table style=" border: 0; padding: 0; margin: 40px auto 20px; outline: 0;font:inherit;width:100%;">
                                <tr>
                                    <td style="text-align:center;padding-bottom:20px;">
                                        <a href="<?php echo $url?>/pwdreset?t=<?php echo $code?>" target="_blank"><img src="<?php echo $url?>/img/mail-btn-reset.jpg" style="border:none;" height="43" alt="重置密码"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-left:20px;">
                                        如以上链接无法打开，请复制以下链接到浏览器地址栏：<br/>
                                        <a href="<?php echo $url?>/pwdreset?t=<?php echo $code?>" style="color: #004ACF;" target="_blank">
                                            <?php echo $url?>/pwdreset?t=<?php echo $code?>
                                        </a>
                                    </td>
                                </tr>
                                <tr>

...
class ModelCode extends CCodeModel
{
	...
	public function prepare()
	{
		...
		foreach($tables as $table)
		{
			...
			if (!is_dir(Yii::getPathOfAlias($this->modelPath).'/table/'))
				@mkdir(Yii::getPathOfAlias($this->modelPath).'/table/', 0700, true);
			$this->files[]=new CCodeFile(
				Yii::getPathOfAlias($this->modelPath).'/table/Table_'.$className.'.php',

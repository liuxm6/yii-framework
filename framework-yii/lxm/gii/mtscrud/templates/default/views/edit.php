<section class="content-header content-header-custom">
    <h1 class="no-border" style="padding:0;">
        <?php echo $this->getMessage("edit-title");?>

    </h1>
    <ol class="breadcrumb">
<?php $fa=true; foreach ((array)$this->getMessage("edit-breadcrumb") as $one):?>
<?php
    if (is_array($one)) {
...
<?php endforeach;?>
        <li class="active"><?php echo $this->getMessage("edit-title");?></li>
    </ol>
</section>
<section class="content">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">
                <?php echo $this->getMessage("edit-box-title");?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <div class="btns-wrapper">
                                    <button class="btn btn-primary" type="submit"><?php echo $this->getMessage("edit-submit-text");?></button>
                                    <a href="<?php echo '<?php';?> echo $this->createUrl('<?php echo '/'.$this->module.'/'.$this->controller.'/index';?>')?>" class="btn btn-default"><?php echo $this->getMessage("edit-return-text");?>

<section class="content-header content-header-custom">
    <h1>
        <?php echo $this->getMessage("edit-fail-title");?>

    </h1>
    <ol class="breadcrumb">
<?php $fa=true; foreach ((array)$this->getMessage("edit-fail-breadcrumb") as $one):?>
<?php
    if (is_array($one)) {
...
<?php endforeach;?>
        <li class="active"><?php echo $this->getMessage("edit-fail-title");?></li>
    </ol>
</section>
        ...
        <div class="box-body">
            ...
            <div class="btns-wrapper">
                <a class="btn btn-default" href="<?php echo '<?php';?> echo $backurl;?>">
                    <?php echo $this->getMessage("edit-fail-return-text");?>
